...
function createStockComponentTemplate() {
    return (
        `<section class="stock">
            <h3>Скидки и акции стоматологии "Искренняя улыбка" на декабрь 2024 г.</h3>
            <div class="container_stock">
                ...
                <div class="stock_item">
                    ...
                    <p class="stock_item_text">Ультразвук, Air Flow, фторирование, полировка.<br> Сообщить до приема.
                    </p>
                ...
                <div class="stock_item">
                    ...
                    <p class="stock_item_text">Несъемный протез на 4 имплантах на всю челюсть!<br>
                        Сообщить до приема.</p>
                    <button class="button_consultation">Консультация</button>
                ...
                <div class="stock_item">
                    ...
                    <h4 class="stock_item_title">ЛЕЧЕНИЕ ЗУБОВ ВО СНЕ, ПЕРВЫЙ ЧАС НАРКОЗА 15 000 руб, ПОСЛЕДУЮЩИЕ ЧАСЫ - 9 000 руб</h4>
                    <p class="stock_item_text"> Сообщить до приема.
                    </p>
                    <button class="button_consultation">Консультация</button>
                ...
                <div class="stock_item">
                    ...
                    <h4 class="stock_item_title">КОМПЛЕКСНАЯ ПРОФЕССИОНАЛЬНАЯ ГИГИЕНА ЗУБОВ ЗА ВЗРОСЛЫМ 5000 РУБ., ДЕТЯМ
                        4000 РУБ.</h4>
                    <p class="stock_item_text">Снятие зубного камня методом ультразвук;<br>
                        ...
                        фторирование всех поверхностей зубов.
                        Сообщить до приема.</p>
                        <button class="button_consultation">Консультация</button>
                ...
                <div class="stock_item">
                    <img src="images/stock8.jpg" alt="" class="img_stock">
                    <h4 class="stock_item_title">Скидка 25% на чистку по сертификату, выданному в нашей клинике</h4>
                    <p class="stock_item_text">Сертификат выдается пациентам, кто закончил план лечения,
                    просанировался.<br>
                    Сообщить до приема.</p>
                    <button class="button_consultation">Консультация</button>
                ...
                <div class="stock_item">
                    <img src="images/stock9.jpg" alt="" class="img_stock">
                    <h4 class="stock_item_title">Комплекс профессиональной гигиены полости рта за 3500 руб</h4>
                    <p class="stock_item_text">Ультразвук, Air Flow, фторирование, полировка.<br> Сообщить до приема.
                    </p>
                    <button class="button_consultation">Консультация</button>
